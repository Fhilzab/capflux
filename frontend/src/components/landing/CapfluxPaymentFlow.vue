  ...
  <div class="capflux-payment-flow" :class="{ 'reduced-motion': isReducedMotion }" aria-hidden="true">
    ...
    >
      ...
      <g class="school-payment" filter="url(#card-shadow)">
        <rect x="0" y="40" width="160" height="120" rx="12" fill="url(#card-bg)" stroke="var(--color-border)" stroke-width="1.5" />
        <rect x="0" y="40" width="160" height="32" rx="12" fill="var(--color-brand-soft)" />
        <rect x="0" y="60" width="160" height="12" fill="var(--color-brand-soft)" />

        <!-- School building illustration -->
        <g transform="translate(48, 76)">
          <rect x="15" y="24" width="34" height="26" rx="3" fill="var(--color-brand)" opacity="0.15" stroke="var(--color-brand)" stroke-width="1.2" />
          <path d="M32 4 L54 24 L10 24 Z" fill="var(--color-brand)" opacity="0.5" />
          <rect x="24" y="34" width="12" height="16" rx="2" fill="var(--color-brand)" opacity="0.3" />
          <rect x="14" y="28" width="7" height="7" rx="1" fill="var(--color-brand)" opacity="0.25" />
          <rect x="38" y="28" width="7" height="7" rx="1" fill="var(--color-brand)" opacity="0.25" />
        </g>

        <text x="80" y="132" text-anchor="middle" class="label-school">School Payment</text>
        <text x="80" y="150" text-anchor="middle" class="text-amount">₦120,000</text>
      </g>

      <text x="80" y="182" text-anchor="middle" class="text-muted">Parents pay school fees</text>
      <text x="80" y="196" text-anchor="middle" class="text-muted-small">Via bank transfer, card or USSD</text>

      <!-- ====== PAYMENT ROUTE ====== -->
      <g class="payment-route">
        <path
          d="M 160 100 C 200 100, 220 100, 260 100"
          stroke="url(#path-gradient)"
          stroke-width="2.5"
          stroke-dasharray="6 4"
          class="connection-path"
        />
        <circle cx="160" cy="100" r="5" fill="var(--color-brand)" opacity="0.5" />
        <circle cx="260" cy="100" r="5" fill="var(--color-brand)" opacity="0.5" />

        <!-- Animated payment particle -->
        <circle r="7" fill="url(#particle-gradient)" class="payment-particle" filter="url(#core-glow)">
          <animateMotion
            dur="1.2s"
            ...
            path="M 160 100 C 200 100, 220 100, 260 100"
          />
          <animate
      ...
      <g class="capflux-core">
        <!-- Outer pulse rings -->
        <circle cx="310" cy="100" r="78" fill="none" stroke="var(--color-brand)" stroke-width="2" opacity="0.18" class="core-ring-outer" />
        <circle cx="310" cy="100" r="66" fill="none" stroke="var(--color-brand)" stroke-width="1.5" opacity="0.12" class="core-ring-inner" />

        <!-- Core background -->
        <circle cx="310" cy="100" r="56" fill="var(--color-card)" stroke="var(--color-brand)" stroke-width="3" class="core-bg" />

        <!-- CAPFLUX geometric logo - interlocking diamond knot -->
        <g class="core-logo" transform="translate(276, 66) scale(0.054)">
        ...
        <!-- Pulse burst -->
        <circle cx="310" cy="100" r="56" fill="none" stroke="var(--color-brand)" stroke-width="2.5" class="capflux-pulse" opacity="0" />
      </g>

      <!-- ====== VERIFICATION BADGE ====== -->
      <g class="verification-badge">
        <rect x="248" y="12" width="144" height="36" rx="18" fill="var(--color-card)" stroke="var(--color-success)" stroke-width="1.5" />
        <circle cx="272" cy="30" r="10" fill="var(--color-success-soft)" />
        <path d="M268 30 L271 33 L277 26" stroke="var(--color-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="verification-check" />
        <text x="292" y="27" class="verification-text">Payment Verified</text>
        <text x="292" y="40" class="verification-subtext">in seconds</text>
      </g>

      <!-- CAPFLUX label -->
      <text x="310" y="186" text-anchor="middle" class="capflux-label-text">CAPFLUX</text>
      <text x="310" y="202" text-anchor="middle" class="capflux-subtext">Verifies, allocates and</text>
      <text x="310" y="216" text-anchor="middle" class="capflux-subtext">reconciles automatically</text>

      <!-- Down arrow from CAPFLUX -->
      <path d="M310 226 L310 244" stroke="var(--color-brand)" stroke-width="1.5" stroke-dasharray="3 3" opacity="0.4" />
      <path d="M305 240 L310 248 L315 240" fill="var(--color-brand)" opacity="0.4" />

      <!-- ====== STUDENT ACCOUNTS ====== -->
      <g class="student-accounts">
        <text x="470" y="16" text-anchor="middle" class="section-label">Individual Student Accounts</text>
        <text x="470" y="30" text-anchor="middle" class="section-sublabel">Each student gets a dedicated bank account</text>

        <!-- Card 1: Tunde A. -->
        <g class="student-card active-card-1" filter="url(#card-shadow)">
          <rect x="385" y="40" width="170" height="52" rx="10" fill="var(--color-card)" stroke="var(--color-brand)" stroke-width="1.5" class="card-border" />
          <circle cx="410" cy="66" r="14" fill="var(--color-brand-soft)" />
          <text x="410" y="70" text-anchor="middle" class="avatar-text">T</text>
          <text x="432" y="58" class="student-name">Tunde A.</text>
          <text x="432" y="70" class="student-class">10A · JSS 1</text>
          <text x="432" y="82" class="student-amount">₦120,000</text>
          <circle cx="538" cy="66" r="9" fill="var(--color-success-soft)" />
          <path d="M534 66 L537 69 L543 62" stroke="var(--color-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="check-mark" />
        </g>

        <!-- Card 2: Amina B. -->
        <g class="student-card active-card-2" filter="url(#card-shadow)">
          <rect x="385" y="100" width="170" height="52" rx="10" fill="var(--color-card)" stroke="var(--color-border)" stroke-width="1" class="card-border" />
          <circle cx="410" cy="126" r="14" fill="var(--color-brand-soft)" />
          <text x="410" y="130" text-anchor="middle" class="avatar-text">A</text>
          <text x="432" y="118" class="student-name">Amina B.</text>
          <text x="432" y="130" class="student-class">8B · JSS 2</text>
          <text x="432" y="142" class="student-amount">₦95,000</text>
          <circle cx="538" cy="126" r="9" fill="var(--color-success-soft)" />
          <path d="M534 126 L537 129 L543 122" stroke="var(--color-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="check-mark" />
        </g>

        <!-- Card 3: Chidi K. -->
        <g class="student-card active-card-3" filter="url(#card-shadow)">
          <rect x="385" y="160" width="170" height="52" rx="10" fill="var(--color-card)" stroke="var(--color-border)" stroke-width="1" class="card-border" />
          <circle cx="410" cy="186" r="14" fill="var(--color-brand-soft)" />
          <text x="410" y="190" text-anchor="middle" class="avatar-text">C</text>
          <text x="432" y="178" class="student-name">Chidi K.</text>
          <text x="432" y="190" class="student-class">11C · SS 1</text>
          <text x="432" y="202" class="student-amount">₦120,000</text>
          <circle cx="538" cy="186" r="9" fill="var(--color-success-soft)" />
          <path d="M534 186 L537 189 L543 182" stroke="var(--color-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="check-mark" />
        </g>

        <!-- Card 4: Zainab S. -->
        <g class="student-card active-card-4" filter="url(#card-shadow)">
          <rect x="385" y="220" width="170" height="52" rx="10" fill="var(--color-card)" stroke="var(--color-border)" stroke-width="1" class="card-border" />
          <circle cx="410" cy="246" r="14" fill="var(--color-brand-soft)" />
          <text x="410" y="250" text-anchor="middle" class="avatar-text">Z</text>
          <text x="432" y="238" class="student-name">Zainab S.</text>
          <text x="432" y="250" class="student-class">9A · JSS 3</text>
          <text x="432" y="262" class="student-amount">₦75,000</text>
          <circle cx="538" cy="246" r="9" fill="var(--color-success-soft)" />
          <path d="M534 246 L537 249 L543 242" stroke="var(--color-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="check-mark" />
        </g>
      </g>

      <!-- ====== CONNECTIONS TO STUDENTS ====== -->
      <g class="student-connections" opacity="0.4">
        <path d="M 366 100 C 380 100, 385 66, 385 66" stroke="var(--color-brand)" stroke-width="1.2" stroke-dasharray="3 3" class="account-path" />
        <path d="M 366 100 C 380 100, 385 126, 385 126" stroke="var(--color-brand)" stroke-width="1.2" stroke-dasharray="3 3" class="account-path" />
        <path d="M 366 100 C 380 100, 385 186, 385 186" stroke="var(--color-brand)" stroke-width="1.2" stroke-dasharray="3 3" class="account-path" />
        <path d="M 366 100 C 380 100, 385 246, 385 246" stroke="var(--color-brand)" stroke-width="1.2" stroke-dasharray="3 3" class="account-path" />
      </g>

      <!-- ====== RECENT TRANSACTIONS PANEL ====== -->
      <g class="transaction-panel" filter="url(#card-shadow)">
        <rect x="570" y="8" width="110" height="270" rx="10" fill="var(--color-card)" stroke="var(--color-border)" stroke-width="1" />
        <text x="625" y="28" text-anchor="middle" class="panel-header">Recent Transactions</text>
        <line x1="580" y1="36" x2="670" y2="36" stroke="var(--color-divider)" stroke-width="0.5" />

        <!-- Row 1 -->
        <g class="transaction-row row-1">
          <circle cx="586" cy="54" r="5" fill="var(--color-brand-soft)" />
          <text x="596" y="57" class="tx-name">Tunde A.</text>
          <text x="668" y="57" text-anchor="end" class="tx-amount">₦120k</text>
          <text x="668" y="68" text-anchor="end" class="tx-time">Just now</text>
        </g>

        <!-- Row 2 -->
        <g class="transaction-row row-2">
          <circle cx="586" cy="88" r="5" fill="var(--color-brand-soft)" />
          <text x="596" y="91" class="tx-name">Amina B.</text>
          <text x="668" y="91" text-anchor="end" class="tx-amount">₦95k</text>
          <text x="668" y="102" text-anchor="end" class="tx-time">12 mins ago</text>
        </g>

        <!-- Row 3 -->
        <g class="transaction-row row-3">
          <circle cx="586" cy="122" r="5" fill="var(--color-brand-soft)" />
          <text x="596" y="125" class="tx-name">Chidi K.</text>
          <text x="668" y="125" text-anchor="end" class="tx-amount">₦120k</text>
          <text x="668" y="136" text-anchor="end" class="tx-time">1 hour ago</text>
        </g>

        <!-- Row 4 -->
        <g class="transaction-row row-4">
          <circle cx="586" cy="156" r="5" fill="var(--color-brand-soft)" />
          <text x="596" y="159" class="tx-name">Zainab S.</text>
          <text x="668" y="159" text-anchor="end" class="tx-amount">₦75k</text>
          <text x="668" y="170" text-anchor="end" class="tx-time">2 hours ago</text>
        </g>

        <line x1="580" y1="182" x2="670" y2="182" stroke="var(--color-divider)" stroke-width="0.5" />

        <!-- Reconciliation state -->
        <g class="reconciliation-state">
          <circle cx="588" cy="200" r="7" fill="var(--color-success-soft)" />
          <path d="M585.5 200 L587.5 202.5 L591 197" stroke="var(--color-success)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="recon-check" />
          <text x="600" y="203" class="recon-text">All payments verified</text>
          <text x="600" y="216" class="recon-subtext">No manual checks. No missing payments.</text>
        </g>
      </g>
...
@keyframes account-flow {
  ...
  50% { opacity: 0.6; }
  100% { stroke-dashoffset: -14; opacity: 0.4; }
}
