...
<template>
  <aside class="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col bg-slate-950/95 backdrop-blur-xl border-r border-slate-800/50">
    <!-- School branding -->
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
      <button
        ...
        class="relative flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition-all duration-200 focus-ring"
      ...
      >
        ...
        <svg v-else-if="item.icon === 'users'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <svg v-else-if="item.icon === 'user-group'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <svg v-else-if="item.icon === 'currency-dollar'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659L12 17.271l2.121-.605L12 13.182M8.272 3h7.456c.553 0 1.007.447 1.007.999V5.5c0 .552-.447 1-.999 1H8.272c-.552 0-1-.447-1-.999V3.999c0-.552.447-.999.999-1zM12 18a3 3 0 100-6 3 3 0 000 6z" />
        </svg>

        <svg v-else-if="item.icon === 'credit-card'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <svg v-else-if="item.icon === 'banknotes'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <svg v-else-if="item.icon === 'bell'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <svg v-else-if="item.icon === 'chart-bar'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <svg v-else-if="item.icon === 'lifebuoy'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <!-- Logout -->
    <div class="border-t border-slate-800/50 px-3 py-4">
      <button
        @click="logout"
        class="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-rose-400 hover:bg-rose-500/10 transition-colors focus-ring"
      >
