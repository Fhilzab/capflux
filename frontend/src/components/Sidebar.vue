  ...
  >
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-divider">
      <div class="flex items-center gap-3" :class="{ 'justify-center w-full': collapsed }">
        ...
        <div v-if="!collapsed" class="flex h-10 w-10 items-center justify-center rounded-button bg-brand text-background font-bold text-lg shadow-card">
          C
        </div>
        <div v-else class="flex h-10 w-10 items-center justify-center rounded-button bg-brand text-background font-bold text-lg shadow-card">
          C
        </div>
      ...
      <div v-for="(group, groupIndex) in navGroups" :key="group.label" class="mb-6 last:mb-0">
        ...
        <div class="px-3 space-y-1">
          ...
          >
            ...
            <svg v-if="item.icon === 'dashboard'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'users'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'user-group'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'credit-card'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'banknotes'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'chart-bar'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'bell'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'cog'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <svg v-else-if="item.icon === 'lifebuoy'" class="h-5 w-5 flex-shrink-0" :class="isActive(item.name) ? 'text-brand' : 'text-text-muted'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
