 ...
 * EmailProvider
 *
 * Stub implementation — no SMTP implementation yet.
 * Future: SendGrid, Mailgun, AWS SES integration.
 *
 * This provider records the delivery attempt but does not actually send email.
 */
  ...
  async send(
    ...
    try {
      const attempt: DeliveryAttempt = {
        ...
        status: 'FAILED',
        errorMessage: 'Email provider not yet configured. Email delivery is a stub.',
