 ...
 *
 * This middleware runs alongside the existing WorkOS requireAuth — it is not
 * a replacement until the migration is complete and WorkOS routes are removed.
 */
import { supabase } from '../supabaseClient.js';

export async function requireAuthSupabase(req, res, next) {
  try {
    ...
    console.error('requireAuthSupabase error:', error?.message || error);
