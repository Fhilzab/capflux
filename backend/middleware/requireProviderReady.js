...
class RequireProviderReady {
  constructor() {
    this.disabledMessage = 'Payment processing is not available at this time.';
    this.notConfiguredMessage = 'Payment processing is not yet configured.';
  }

  /**
   * Express middleware factory.
   * @param {Object} [opts]
   * @param {string} [opts.provider] — required provider name (optional check)
