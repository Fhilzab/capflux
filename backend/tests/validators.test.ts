...
test('VALID_BUSINESS_TYPE_VALUES contains all 9 NIGERIAN entity types', () => {
  assert.equal(VALID_BUSINESS_TYPE_VALUES.length, 9);
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('BUSINESS_NAME'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('PARTNERSHIP'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('PRIVATE_LIMITED_COMPANY'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('PUBLIC_LIMITED_COMPANY'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('LIMITED_BY_GUARANTEE'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('UNLIMITED_COMPANY'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('LLP'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('LP'));
  assert.ok(VALID_BUSINESS_TYPE_VALUES.includes('INCORPORATED_TRUSTEES'));
});
